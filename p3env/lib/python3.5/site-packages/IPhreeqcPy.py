...
class IPhreeqc():
    ...
    def __init__(self, dll_path=None):
        ...
        method_mapping = [('_AccumulateLine', phreeqc.AccumulateLine,
                          ...
                          ('_GetDumpString',
                           ...
                           ctypes.c_char_p),
                          ('_SetOutputStringOn',phreeqc.SetOutputStringOn,[c_int,c_int],c_int),
                          ('_GetOutputString',phreeqc.GetOutputString, [c_int],
                                  ctypes.c_char_p),
                         ]
    ...
    def SetOutputStringOn(self):
        self._SetOutputStringOn(self.id,1)
    ...
    def GetOutputString(self):
        return self._GetOutputString(self.id)
